...
function init_game() {
    ...
    document.getElementById("custom-button").addEventListener("click", custom_button);
...
function geneate_board(rows_g, columns_g, bombs_g) {
    clear_board();
...
function custom_button() {
    ...
    geneate_board(rows_t, columns_t, bombs_on_board_t)
}

function small_button() {
    geneate_board(9, 9, 10);

}

function medium_button() {
    geneate_board(16, 16, 40);
}

function large_button() {
    geneate_board(16, 30, 99);
